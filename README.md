...
```git clone https://github.com/mariana-pereira/finances-api.git```

SSH URLs provide access to a Git repository via SSH, a secure protocol. If you have a SSH key registered in your Github account, clone the project using this command:

```git clone git@github.com:mariana-pereira/finances-api.git```
...
Run `npx prisma migrate dev --schema=src/infra/database/prisma/schema.prisma` in order to run the migrations.

Run `yarn start:dev` in order to start the application in a development environment.
